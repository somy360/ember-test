...
class _$DepartureImpl implements _Departure {
  _$DepartureImpl({this.scheduled, this.actual, this.estimated});
  ...
  @override
  String toString() {
    return 'Departure(scheduled: $scheduled, actual: $actual, estimated: $estimated)';
  }
...
abstract class _Departure implements Departure {
  factory _Departure(
      {final String? scheduled,
      final String? actual,
      final String? estimated}) = _$DepartureImpl;
